...
This project is indexed by GitNexus as **project-pantheon** (999 symbols, 2292 relationships, 65 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
