...
This project is indexed by GitNexus as **project-pantheon** (927 symbols, 2084 relationships, 44 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
