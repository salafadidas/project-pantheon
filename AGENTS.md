...
This project is indexed by GitNexus as **project-pantheon** (886 symbols, 1917 relationships, 31 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
