...
This project is indexed by GitNexus as **project-pantheon** (784 symbols, 1630 relationships, 32 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
