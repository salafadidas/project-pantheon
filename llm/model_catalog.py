...
All prices are per 1M tokens (USD) as of 2026-05.
...
DEBATE_MODELS: list[ModelInfo] = [
    ...
    ModelInfo(
        ...
        price_output_per_1m=10.00,
        context_window_k=1_000,
        strengths=["OpenAI flagship 2026", "Best reasoning + knowledge", "1M context"],
        env_key="OPENAI_API_KEY",
    ),
    # ── Google ───────────────────────────────────────────────────────────────
    ModelInfo(
    ...
    # ⚠️ DEPRECATED — Google shuts down 2026-06-01; migrate to gemini-2.5-flash
    ModelInfo(
        ...
        context_window_k=1_000,
        strengths=["⚠️ Deprecated Jun 1 2026", "Fastest response", "Very cheap"],
        env_key="GOOGLE_API_KEY",
    ),
    # ⚠️ DEPRECATED — Google shuts down 2026-06-01; migrate to gemini-2.5-flash-lite
    ModelInfo(
        ...
        context_window_k=1_000,
        strengths=["⚠️ Deprecated Jun 1 2026", "Cheapest Google model", "1M context"],
        env_key="GOOGLE_API_KEY",
    ),
    ModelInfo(
        ...
        price_output_per_1m=0.40,
        context_window_k=1_000,
        strengths=["Cheapest 2.5-class", "1M context", "Fast & lightweight"],
        env_key="GOOGLE_API_KEY",
    ),
